...
class MegaminxDrawer:
    ...
    def draw(self, scr, minx):
        """ draw puzzle """
        pygame.draw.polygon(scr, (0,0,0), self.body)
        for i in range(11):
            pygame.draw.polygon(scr, pygame.Color(minx.up[i]), self.up[i])
            pygame.draw.polygon(scr, pygame.Color(minx.front[i]), self.front[i])
            pygame.draw.polygon(scr, pygame.Color(minx.left[i]), self.left[i])
            pygame.draw.polygon(scr, pygame.Color(minx.right[i]), self.right[i])
            pygame.draw.polygon(scr, pygame.Color(minx.downLeft[i]), self.downLeft[i])
            pygame.draw.polygon(scr, pygame.Color(minx.downRight[i]), self.downRight[i])
